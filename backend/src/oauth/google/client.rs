...
impl GoogleClient {
    pub fn new() -> Result<Self> {
        Ok(GoogleClient {
            oauth_client: GoogleOauth::new()?,
            http_client: reqwest::Client::new(),
        })
    }

    pub async fn get_authorization_url(&self, id: i32) -> AuthorizationFlow {
        self.oauth_client.authorization_url(id)
    }
    ...
    pub async fn exchange_code(
        ...
        self.oauth_client.exchange_code(code, pkce_verifier).await
    }
...
impl GoogleOauth {
    pub fn new() -> Result<Self> {
        let http_client = reqwest::Client::builder()
            ...
            .build()
            .unwrap();
        let redirect_uri = RedirectUrl::new(format!("{}/google/oauth", CONFIG.app_url))?;
        let revocation_url =
